...
if __name__=="__main__":
    ...
    training_namelist = "outputs//simple_example_model-hyricical///variables_info-Forest_consec_dry_mean_tas_max_cropland_pasture_cveg_savanna_np_lightn-frac_points_0.005-nvariables_-frac_random_sample0.005-nvars_9-niterations_100.txt"
