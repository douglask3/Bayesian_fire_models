## model info
regions:: ['Pantanal']
model_title::  'attribution-base-localBA-data-SuperSlimmed-6/<<region>>'
...
priors:: {'pname': "controlID", 'value': [[7, 13], [2], [4], [5]]}
priors:: {'pname': "driver_Direction", 'value': [[1, 1], [-1], [-1], [1]]}
