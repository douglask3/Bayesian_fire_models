...
file_pattern_1 = r"C:/Users/rmvre/OneDrive/Documents/SoW_2024_2025/Pantanal/data_csv/means/plotD/*_anomaly.csv"
file_pattern_2 = r"C:/Users/rmvre/OneDrive/Documents/SoW_2024_2025/Pantanal/data_csv/pc-95.0/plotD/*_anomaly.csv"
...
for i in range(n_rows):
    axes[i, 0].set_ylabel(legend_labels[i], rotation = 90, fontsize=8)
    axes[i, 0].yaxis.set_label_position("left")
    axes[i, 0].yaxis.label.set_ha('center')

#title for the whole plot
fig.suptitle('Pantanal', fontsize=12, fontweight='bold', y=0.94)    
