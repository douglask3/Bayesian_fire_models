...
def for_region(region):
    mod_dir = "outputs/outputs_scratch/ConFLAME_nrt-drivers4/" + region + "-2425/time_series/_21-frac_points_0.5/baseline-/mean/members/"
    obs_file = "data/data/driving_data2425/" + region + "/burnt_area_data.csv"
