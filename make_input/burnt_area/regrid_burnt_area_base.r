...
shape_file = "data/BASE_shapes/"
shape_names = list("Amazon", "Pantanal")

eg_raster_dir  = "data/data/driving_data_base/<<REGION>>/isimp3a/obsclim/GSWP3-W5E5/period_2002_2019/tree_cover_jules-es.nc"
eg_raster_nrt_dir = 'data/data/driving_data_base/<<REGION>>/nrt/era5_monthly/precip.nc'
out_file_hires  = "data/data/driving_data_base/<<REGION>>/burnt_area.nc"
out_file_nrt    = "data/data/driving_data_base/<<REGION>>/nrt/era5_monthly/burnt_area.nc"
out_file_isimip = "data/data/driving_data_base/<<REGION>>/isimp3a/obsclim/GSWP3-W5E5/period_2002_2019/burnt_area.nc"
dat = rast(files)
...
for_region <- function(rname, sname = rname) {
    ...
    shp = vect(paste0(shape_file, sname, '/', sname, '.shp'))
    extent = ext(shp)
