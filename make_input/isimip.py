...
def make_variables_for_year_range(year, process, dir, dataset_name, filenames,
    ...
    def open_variable(varname, MinusYr = False):
        ...
        if (subset_functions is not None):
             sbs_funs = sbs_funs+ subset_functions 
        if (subset_function_argss is not None): 
            sbs_args = sbs_args -subset_function_argss
...
def for_region(subset_functions, subset_function_argss, vcf_region_name, region_name = None):   
    ...
    dir_clim = "/hpc//data/d00/hadea/isimip3a.for_delete/InputData/climate/atmosphere/obsclim/GSWP3-W5E5/gswp3-w5e5_obsclimfill_"
    dir_jules = "/scratch/hadea/isimip3a.for_delete/u-cc669_isimip3a_es/GSWP3-W5E5_obsclim/jules-es-vn6p3_gswp3-w5e5_obsclim_histsoc_default_pft-"  
